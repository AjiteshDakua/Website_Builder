      ...
      <div className="space-y-4 text-black">
        <div>
          ...
          <textarea
           ...
           border border-gray-400 rounded-md focus:ring-2 focus:ring-indigo-500 outline-none min-h-20"
          />
        </div>
        <div>
          <label className="block text-xs font-medium text-gray-500 mb-1">
          ...
          <input
            ...
            className="w-full text-sm p-2
           border border-gray-400 rounded-md focus:ring-2 focus:ring-indigo-500 outline-none"
          />
        </div>
