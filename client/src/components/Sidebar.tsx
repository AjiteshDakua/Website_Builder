...
const Sidebar = ({
  ...
  return (
    <div
      className={`h-full sm:max-w-sm rounded-xl bg-gray border-gray-800 transition-all${
            ...
            .map((message) => {
              ...
              if (isMessage) {
                ...
                return (
                  <div
                    key={ver.id}
                    className="w-4/5 mx-auto my-2 p-3 rotate-xl bg-gray-800 text-gray-100 shadow flex flex-col gap-2"
                  >
        ...
        <form onSubmit={handleRevisions} className="m-3 relative">
          <div className="flex items-center gap-2">
            <textarea
              ...
              value={input}
              rows={4}
              placeholder="Describe your idea or the changes you want..."
